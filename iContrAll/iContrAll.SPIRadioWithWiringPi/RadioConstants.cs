...
namespace iContrAll.SPIRadio
{
    public static class RadioConstants
    {
        ...
        static byte[] RF_GPIO_PIN_CFG = new byte[] { 0x13, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
        ...
        static byte[] RF_INT_CTL_ENABLE_2 = new byte[] { 0x11, 0x01, 0x02, 0x00, 0x01, 0x38 };
        ...
        static byte[] RF_PKT_CRC_CONFIG_1 = new byte[] { 0x11, 0x12, 0x01, 0x00, 0x80 };
        static byte[] RF_PKT_WHT_SEED_15_8_4 = new byte[] { 0x11, 0x12, 0x04, 0x03, 0xFF, 0xFF, 0x00, 0x02 };
        static byte[] RF_PKT_LEN_12 = new byte[] { 0x11, 0x12, 0x0C, 0x08, 0x00, 0x00, 0x00, 0x30, 0x30, 0x00, 0x07, 0x04, 0x00, 0x00, 0x00, 0x00 };
        ...
        static byte[] RF_MODEM_MOD_TYPE_12 = new byte[] { 0x11, 0x20, 0x0C, 0x00, 0x02, 0x00, 0x07, 0x01, 0x86, 0xA0, 0x01, 0xC9, 0xC3, 0x80, 0x00, 0x02 };
        static byte[] RF_MODEM_FREQ_DEV_0_1 = new byte[] { 0x11, 0x20, 0x01, 0x0C, 0xBB };
        static byte[] RF_MODEM_TX_RAMP_DELAY_8 = new byte[] { 0x11, 0x20, 0x08, 0x18, 0x01, 0x80, 0x08, 0x03, 0xC0, 0x00, 0x20, 0x20 };
        static byte[] RF_MODEM_BCR_OSR_1_9 = new byte[] { 0x11, 0x20, 0x09, 0x22, 0x01, 0x77, 0x01, 0x5D, 0x86, 0x00, 0xAF, 0x02, 0xC2 };
        static byte[] RF_MODEM_AFC_GEAR_7 = new byte[] { 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0x80, 0x0F, 0x15, 0x57, 0x80 };
        static byte[] RF_MODEM_AGC_CONTROL_1 = new byte[] { 0x11, 0x20, 0x01, 0x35, 0xE2 };
        static byte[] RF_MODEM_AGC_WINDOW_SIZE_9 = new byte[] { 0x11, 0x20, 0x09, 0x38, 0x11, 0x52, 0x52, 0x00, 0x02, 0xFF, 0xFF, 0x00, 0x2A };
        static byte[] RF_MODEM_OOK_CNT1_11 = new byte[] { 0x11, 0x20, 0x0B, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x01, 0x20, 0x01, 0x80, 0xFF, 0x0C, 0x00 };
        ...
        static byte[] RF_FREQ_CONTROL_INTE_8 = new byte[] { 0x11, 0x40, 0x08, 0x00, 0x38, 0x0E, 0xEE, 0xEE, 0x22, 0x22, 0x20, 0xFF };




        //static byte[] RF_POWER_UP = new byte[] { 0x02, 0x01, 0x00, 0x01, 0xC9, 0xC3, 0x80 };
        //static byte[] RF_GPIO_PIN_CFG = new byte[] { 0x13, 0x61, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00 };
        //static byte[] RF_GLOBAL_XO_TUNE_1 = new byte[] { 0x11, 0x00, 0x01, 0x00, 0x52 };
        //static byte[] RF_GLOBAL_CONFIG_1 = new byte[] { 0x11, 0x00, 0x01, 0x03, 0x60 };
        ...
        //static byte[] RF_PKT_FIELD_2_CRC_CONFIG_12 = new byte [] { 0x11, 0x12, 0x0C, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
        //static byte[] RF_PKT_FIELD_5_CRC_CONFIG_1 = new byte [] { 0x11, 0x12, 0x01, 0x20, 0x00 };
        //static byte[] RF_MODEM_MOD_TYPE_12 = new byte [] { 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x06, 0x1A, 0x80, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x00 };
        ...
        //static byte[] RF_MODEM_BCR_OSR_1_9 = new byte [] { 0x11, 0x20, 0x09, 0x22, 0x00, 0xFA, 0x02, 0x0C, 0x4A, 0x04, 0x19, 0x0A, 0x00 };
        //static byte[] RF_MODEM_AFC_GEAR_7 = new byte [] { 0x11, 0x20, 0x07, 0x2C, 0x00, 0x12, 0x80, 0x2C, 0x06, 0x9D, 0xE0 };
        //static byte[] RF_MODEM_AGC_CONTROL_1 = new byte [] { 0x11, 0x20, 0x01, 0x35, 0xE2 };
        //static byte[] RF_MODEM_AGC_WINDOW_SIZE_9 = new byte [] { 0x11, 0x20, 0x09, 0x38, 0x11, 0x37, 0x37, 0x00, 0x1A, 0x20, 0x00, 0x00, 0x29 };
        //static byte[] RF_MODEM_OOK_CNT1_11 = new byte [] { 0x11, 0x20, 0x0B, 0x42, 0xA4, 0x03, 0xD6, 0x03, 0x00, 0x26, 0x01, 0x84, 0xFF, 0x0C, 0x01 };
        //static byte[] RF_MODEM_RSSI_COMP_1 = new byte [] { 0x11, 0x20, 0x01, 0x4E, 0x40 };
        //static byte[] RF_MODEM_CLKGEN_BAND_1 = new byte [] { 0x11, 0x20, 0x01, 0x51, 0x08 };
        //static byte[] RF_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12 = new byte [] { 0x11, 0x21, 0x0C, 0x00, 0xFF, 0xBA, 0x0F, 0x51, 0xCF, 0xA9, 0xC9, 0xFC, 0x1B, 0x1E, 0x0F, 0x01 };
        //static byte[] RF_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12 = new byte [] { 0x11, 0x21, 0x0C, 0x0C, 0xFC, 0xFD, 0x15, 0xFF, 0x00, 0x0F, 0xFF, 0xBA, 0x0F, 0x51, 0xCF, 0xA9 };
